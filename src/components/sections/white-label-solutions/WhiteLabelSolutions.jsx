    ...
    >
      ...
      <motion.div variants={itemVariants}>
        <SectionHeader
          ...
          subtitle="Lance sua plataforma de marca em semanas usando nosso ecossistema de 12 módulos"
        />
      </motion.div>
      ...
      <div className="flex flex-col items-center gap-12 md:flex-row md:gap-16">
        ...
        >
          ...
          >
            Transforme sua organização com uma plataforma de finanças digitais
            totalmente personalizada, que carrega
          </motion.p>

          {/* Animated Bars */}
          <div className="space-y-2 lg:space-y-3">
            {[
              { width: "60%", color: "#CC6600", text: "SEU nome" },
              { width: "80%", color: "#B25900", text: "SUA identidade" },
              { width: "100%", color: "#994D00", text: "SUAS cores" },
            ].map((bar, index) => (
              <motion.div
                key={index}
