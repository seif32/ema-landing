...
const differenceCards = [
  {
    emoji: MoneyBag,
    value: "60k",
    description: "Transactions via notre plateforme",
  },
  {
    emoji: TippingHand,
    value: "58%",
    description: "Réduction du coût des paiements réalisée",
  },
  {
    emoji: PeopleHugging,
    value: "50%",
    description: "PIB de l'Afrique provient des MPME que nous soutenons",
  },
  {
    emoji: MoneyFlies,
    value: "125M",
    description: "Marché potentiel de bénéficiaires de PME",
  },
];
...
function EmaDifference() {
  ...
  return (
    ...
    >
      ...
      >
        <h2 className="text-2xl md:text-4xl">La Différence eMa</h2>
        <p className="text-lg leading-none text-muted-foreground">
          Conduire la transformation économique de l'Afrique grâce à
      ...
      <div className="flex flex-col items-center gap-6 lg:flex lg:flex-row">
        ...
        >
          <img src={ManWoman} alt="Homme et Femme" />
        </motion.div>
